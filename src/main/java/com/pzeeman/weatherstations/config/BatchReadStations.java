...
public class BatchReadStations {
    ...
    public JdbcBatchItemWriter<Station> writer() {
        ...
        itemWriter.setSql("INSERT INTO Stations (NAME,PROVINCE,STATION_DATE,MEAN_TEMP,HIGHEST_MONTHLY_MAX_TEMP,LOWEST_MONTHLY_MIN_TEMP) VALUES ( :Name, :Province, :Date, :Mean_Temp, :Highest_Monthly_Maxi_Temp, :Lowest_Monthly_Min_Temp)");
    ...
    public LineMapper<Station> lineMapper() {
        ...
        lineTokenizer.setNames(new String[]{"name", "province", "date", "meanTemp", "highestMonthlyMaxTemp", "lowestMonthlyMinTemp" });
